...
def play():
    ...
    choice = input("would you like to play a game with me?  y/n ")
    ...
    if choice == "n":
        ...
        choice = input("Please choose either y or n. y/n ")
        

def guess():   
    print ("I am thinking of a number between 1 and 10...")
    choice = input("Would you like to guess? y/n ")
...
def begin():
    ...
    guess = input("OK, I have my number...please guess now: 1-10 ?  ")
    count += 1
